...
{
    public partial class FormTokusaiPlan : Form
    {
        public void ShowData()
        {
            ...
            this.BeginInvoke(new Action(() =>
            {
                ...
                this.dataGridView1.DataSource = ECOHelper.GetListTokusaiPlan();
        ...
        public void SearchByWO(string WO)
        {
            ...
            { ShowData(); return; }
            var data = ECOHelper.FindTokusaiPlanByWO(WO);
        ...
        public void SearchByModel(string Model)
        {
            ...
            { ShowData(); return; }
            var data = ECOHelper.FindTokusaiPlanByModel(Model);
        ...
        {
            new FormTokusaiPlanAdd().ShowDialog();
            ShowData();
        }
        ...
        private void btnRemove_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedCells.Count > 0)
            {
                ...
                var res = ECOHelper.TokusaiPlanRemove(id);
