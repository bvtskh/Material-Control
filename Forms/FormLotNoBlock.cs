...
{
    public partial class frmLotNoBlock : Form
    {
        public void ShowData()
        {
            var data = UsapHelper.FindListLotNoLocked();
        ...
        public void ComboboxOptionInit()
        {
            ...
            cbbOption.Items.AddRange(new[] { "LOT NO", "PART NO" });
            this.cbbOption.EndUpdate();
            cbbOption.SelectedIndex = 0;
        }
        public void SearchByLotNo(string lotNo)
        {
            var data = UsapHelper.FindListLotNoLockedLike(lotNo);
        ...
        public void SearchByPartNo(string lotNo)
        {
            var data = UsapHelper.FindListLotNoLockedLike(lotNo);
