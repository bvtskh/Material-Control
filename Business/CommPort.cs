...
namespace Material_System.Business
{
    public sealed class CommPort
    {
        ...
        public void Open()
        {
            ...
            try
            {
                _serialPort.PortName = SystemSettings.Port.PortName;
            ...
            {
                StatusChanged(String.Format("{0} does not exist", SystemSettings.Port.PortName));
            }
            catch (UnauthorizedAccessException)
            {
                StatusChanged(String.Format("{0} already in use", SystemSettings.Port.PortName));
            }
            catch (Exception ex)
            {
